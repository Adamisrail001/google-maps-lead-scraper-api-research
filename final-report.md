...
**API-quality scorecard (all-persona aggregate, /10, max attainable 9.2):** Lobstr 6.46 · Outscraper 6.22 · HasData 5.99 · Bright Data 5.30 · Apify 4.97 — Google scored 7.66 for reference but is **disqualified from the rankings** (below) (`research/analysis/scorecard.md`; HasData/Bright Data scored from their 2026-09-23 stage-2 runs — comparability caveats in the scorecard header; ScrapingDog remains stage-1-only pending its paid plan).
