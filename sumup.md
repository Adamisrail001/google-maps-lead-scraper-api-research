...
6. **Official ranking (Google DQ'd): 1. Lobstr 6.46 · 2. Outscraper 6.22 · 3. HasData 5.99 · 4. Bright Data 5.30 · 5. Apify 4.97** (/10, max attainable 9.2; house product wins — disclosure + public raw evidence attached). Apify: cheapest per row ($0.54/1K, verified-emails-only billing — proven) but silently truncated 4/20 queries via undocumented profit-guards; last place.
